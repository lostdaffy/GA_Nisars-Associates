...
const About = () => {
  const { ref: badgeRef, visible: badgeVisible } = useScrollReveal();
  ...
  return (
    <section className="w-full bg-white py-16 lg:py-24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div
          ref={badgeRef}
          className={`sr-fade-up mb-6 flex justify-center ${badgeVisible ? "sr-visible" : ""}`}
        >
        ...
        <div
          ref={headRef}
          className={`sr-fade-up mx-auto max-w-3xl text-center ${headVisible ? "sr-visible" : ""}`}
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-16">
          ...
          <div
            ref={imgRef}
            className={`sr-fade-left overflow-hidden rounded-3xl border border-[#e5e7eb] shadow-sm ${imgVisible ? "sr-visible" : ""}`}
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#16a34a] sm:h-9 sm:w-9">
                  <svg className="h-3.5 w-3.5 text-white sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.2}>
          ...
          <div
            ref={contentRef}
            className={`sr-fade-right flex flex-col gap-7 ${contentVisible ? "sr-visible" : ""}`}
          ...
          >
                ...
                {highlights.map((item) => (
                  ...
                  >
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#bbf7d0] bg-[#f0fdf4]">
                      <i className="ri-check-line text-[#16a34a]" />
                    </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                <i className="ri-phone-fill" /> Contact Us
              </Link>
            </div>
          </div>
        </div>
